...
public class CarpetaTest {
    ...
    @Test
    void dadaUnaCarpetaQueContieneSubCarpetas_ObtieneElTamanioTotal() {
        sub1.agregar(txt);
        sub2.agregar(mp3);
        sub2.agregar(img);
        root.agregar(sub1);
    ...
    void dadaUnaCarpetaQueContieneSubCarpetas_ObtieneElMasPesado() {
        sub1.agregar(txt);
        sub2.agregar(mp3);
        sub2.agregar(img);
        root.agregar(sub1);
